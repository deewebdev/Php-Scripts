...
$points=array(365,175,365,255,310,255);
imagefilledpolygon($im,$points,3,$white);

$points=array(375,175,435,255,375,255);
imagefilledpolygon($im,$points,3,$white);

imagefilledellipse($im,330,265,25,60,$red);

imagefilledellipse($im,330,225,30,30,$grey);

$points=array(300,260,440,265,420,310,320,310);
imagefilledpolygon($im,$points,4,$brown);

imagesetthickness($im,3);
imageline($im,370,265,370,165,$brown);
